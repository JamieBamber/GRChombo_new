...
run0054=(0.34 0.1 1e-13 0 0 Newtonian_run0031_wslope0.25_wradius50_n001500_ICS) # 10^{-8}
...
run0064=(0.34 0.1 1e-10 0 0 Newtonian_run0031_nowindow_n001500_ICS_G0) # 10^{-10} -- using the ICS file solved with G=0
...
run0081=(0.34 0.1 1e-10 0 0 Newtonian_run0031_nowindow_n001500_noICS) # 10^{-10}

run0036=(0.5 0.125 0 0 0)

run0104=(0.34 0.25 1 0 0 Newtonian_run0031_wslope0.25_wradius50_n001500_boxsize8_Mcloud0.1M)
...
do
	...
	params_file=params_ratio1_ICS.txt
